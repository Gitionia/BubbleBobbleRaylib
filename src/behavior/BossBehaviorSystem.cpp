...
void BossBehaviorSystem::Update() {
    ...
    for (auto entity : view) {
        ...
        const int BOSS_WIDTH = BP_SIZE(4, 0);
        const int BOSS_HEIGHT = BP_SIZE(4, 0);
        ...
        } else if (pos.y + BOSS_HEIGHT >= BP_SIZE(LevelTilemap::HEIGHT - 5, 0)) {
            pos.y = BP_SIZE(LevelTilemap::HEIGHT - 5, 0) - BOSS_HEIGHT;
            boss.yDir *= -1;
        }
    }
}
